<template>
  <div > 
    <div id="slogan" class="text-center">
      <h1>NameGator</h1>
      <br/>
      <h6 class="text-secondary">Name generator using Vue, GraphQL and Node.</h6>
    </div>
    <div id="main">
        <div class="container">
          <div class="row">
                ...
                <div class="card">
                  <div class="card-body">
					...
					<div class="input-group">
						<input class="form-control" type="text" v-model="prefix" v-on:keyup.enter="addPrefix(prefix)" placeholder="Type the prefix" />
                ...
                <div class="card">
                  <div class="card-body">
                   <ul class="list-group">
                    ...
                    <br/>
					<div class="input-group">
						<input class="form-control" type="text" v-model="sufix" v-on:keyup.enter="addSufix(sufix)" placeholder="Digite o sufix" />
						<div class="input-group-append">
